...
import com.salah.gestiondestock.DtoMappers.EntrepriseMapperImpl;
...
public class EntrepriseServiceImpl implements EntrepriseService {
    ...
    private EntrepriseMapperImpl dtoMapper;

    public EntrepriseServiceImpl(EntrpriseRepository entrpriseRepository, EntrepriseMapperImpl dtoMapper, View error) {
